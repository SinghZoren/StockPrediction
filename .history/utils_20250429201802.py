...
def create_stock_plot(canvas_widget, y_train, train_pred, y_test, test_pred, ticker, r2_score, dates):
    ...
    ax2.plot(test_dates, test_pred, label='Testing Data (Predicted)', alpha=0.7, color='lightgreen', linewidth=2)
    ...
    ax1.legend(handles=legend_elements, bbox_to_anchor=(1.02, 1), loc='upper left', fontsize=9,
    ...
    ax2.legend(handles=detail_legend_elements, bbox_to_anchor=(1.02, 1), loc='upper left', fontsize=9,
    ...
    plt.subplots_adjust(right=0.80, bottom=0.15, hspace=0.4)

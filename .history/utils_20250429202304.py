...
def create_stock_plot(canvas_widget, y_train, train_pred, y_test, test_pred, ticker, r2_score, dates):
    ...
    # Set a reasonable width for the actual plot area (70% of total width)
    plot_width = 0.7
    legend_width = 0.25  # Width reserved for legend
    ...
    legend1 = ax1.legend(handles=legend_elements, bbox_to_anchor=(1.01, 1), loc='upper left', fontsize=9,
               ...
               title_fontsize=9)
    legend1.set_bbox_to_anchor((1.01, 1))
    ...
    legend2 = ax2.legend(handles=detail_legend_elements, bbox_to_anchor=(1.01, 1), loc='upper left', fontsize=9,
               ...
               title_fontsize=9)
    legend2.set_bbox_to_anchor((1.01, 1))
    ...
    # Set the subplot parameters to constrain the width of the plots
    plt.subplots_adjust(right=plot_width, bottom=0.15, hspace=0.4, left=left_margin)
